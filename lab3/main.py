...
driver.find_element_by_name("firstname").send_keys("Kateryna")
driver.find_element_by_name("lastname").send_keys("Mozghova")
driver.find_element_by_name('reg_email__').send_keys('kateryna@test.com')
driver.find_element_by_name('reg_email_confirmation__').send_keys('kateryna@test.com')
